...
var RpcServer = require('../lib/rpc').RpcServer;
process.nextTick(function () { return __awaiter(void 0, void 0, void 0, function () {
    var server;
    return __generator(this, function (_a) {
        server = new RpcServer('restro', {
            processOrder: processOrder,
        });
        server.listen().then(function () { return console.log('RPC server listening...'); }).catch(function (err) { return console.log('RPC server failed', err); });
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    setTimeout(function () {
                        ...
                        order.status = 'served';
                        if (Date.now() % 2 === 0)
                            return reject(new Error('Failed to process order'));
