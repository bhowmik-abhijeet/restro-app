...
module.exports.getChannel = function (queues, opt) {
    if (opt === void 0) { opt = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var conn, channel, queueAssertPromise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(queueAssertPromise)];
                case 3:
                    _a.sent();
...
module.exports.publishToQueue = function (channel, queueName, data, props) {
